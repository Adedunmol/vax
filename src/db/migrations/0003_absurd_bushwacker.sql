...
ALTER TABLE "user_otp_verifications" ADD CONSTRAINT "user_otp_verifications_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;